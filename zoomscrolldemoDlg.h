...
// Dialog Data
	...
	CString m_dataTitleD;
	DoubleArray m_timeStampsD;
	DoubleArray m_dataSeriesD;
	CString m_dataTitleE;
	DoubleArray m_timeStampsE;
	DoubleArray m_dataSeriesE;
	CString m_dataTitleF;
	DoubleArray m_timeStampsF;
	DoubleArray m_dataSeriesF;
	CString m_dataTitleG;
	DoubleArray m_timeStampsG;
	DoubleArray m_dataSeriesG;
